###This code will parse Final Hessian matrix and Projected Mass-weighted Hessian matrix from Q-Chem's output file and save them as txt files
...
def ParseInput(ArgsIn):
    UseMsg = '''
    Usage: python [script] [target_dir contains output file generated by Q-Chem]
    '''
